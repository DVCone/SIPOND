                ...
                <div class="body">
                    <div class="row clearfix">
                        <form method="POST" id="formubah">
                            ...
                            <b>Department</b>
                            <div class="form-group">
                                <textarea id="label_department" name="label_pengguna" type="text" class="form-control" readonly /></textarea>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    // tampilan edit department
    $('select[name=pengguna]').on('change', function() {
        $.ajax({
            method: "GET",
            url: "<?php echo base_url();?>index.php/adminsetpengguna/department/" + $(this).val(),
            dataType: "json",
            
            success:function(res) {
                var dept = "";
            $.each(res.dept, function(index, value) {
                    dept += (index + 1) + ". " + value.halaman + "\n"
                })
                
            $('#label_department').html(dept)
