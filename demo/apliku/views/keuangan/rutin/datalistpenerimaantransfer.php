    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                    <div class="block-header" align="center"><b>Laporan Penerimaan Transfer</b></div>
                    <form method="post" action="<?php echo base_url(); ?>index.php/keuanganrutin/penerimaantransfercari">
                      <div class="panel-heading">Cari Periode :
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable-ptransfer" id="mydata">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
                                        <th>No Nota</th>
